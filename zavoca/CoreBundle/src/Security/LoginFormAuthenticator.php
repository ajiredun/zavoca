...
namespace Zavoca\CoreBundle\Security;
...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    {
        return 'zavoca_core_login' === $request->attributes->get('_route')
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, $providerKey)
    {
        ...
        return new RedirectResponse($this->urlGenerator->generate('zavoca_core_main'));
    }
    ...
    {
        return $this->urlGenerator->generate('zavoca_core_login');
    }
}
